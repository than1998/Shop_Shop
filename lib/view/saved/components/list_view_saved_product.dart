...
Widget listViewSavedProduct(context, List productList,onSavedProduct,onNextDetailProductPage) {
  return GridView.builder(
    ...
    itemBuilder: (context, index) {
      return InkWell(
        onTap: () {
          onNextDetailProductPage(productList[index]);
        },
        child: Container(
          ...
          child: Stack(
            children: [
              ...
              Align(
                ...
                child: IconButton(
                  onPressed: () async {
                    onSavedProduct(context,index,productList[index].idProducts,
